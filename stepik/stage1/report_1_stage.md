...
![Задание 8](/home/glebbesputin/Изображения/Снимки экрана/lab/008.png){#fig:009 width=70%}
...
![Задание 9](/home/glebbesputin/Изображения/Снимки экрана/lab/009.png){#fig:010 width=70%}
...
![Задание 10](/home/glebbesputin/Изображения/Снимки экрана/lab/010.png){#fig:011 width=70%}

Ассоль - героиня литературного произведения, а термин - это определение.

![Задание 11](/home/glebbesputin/Изображения/Снимки экрана/lab/011.png){#fig:012 width=70%}

Интерфейс командной строки Linux является регистрозависимым.

![Задание 12](/home/glebbesputin/Изображения/Снимки экрана/lab/012.png){#fig:013 width=70%}

Интерфейс командной строки Linux является регистрозависимым, поэтому не подходит вариант, где буква А - маленькая(строчная).

![Задание 13](/home/glebbesputin/Изображения/Снимки экрана/lab/013.png){#fig:014 width=70%}
...
![Задание 17](/home/glebbesputin/Изображения/Снимки экрана/lab/017.png){#fig:018 width=70%}
...
![Задание 19](/home/glebbesputin/Изображения/Снимки экрана/lab/019.png){#fig:021 width=70%}
...
![Задание 20](/home/glebbesputin/Изображения/Снимки экрана/lab/020.png){#fig:022 width=70%}

1. cat names.txt | ./interacter.py | less = вывод на экран

2. cat names.txt | ./interacter.py 2>err.txt | less = вывод ошибки в err.txt

![Задание 21](/home/glebbesputin/Изображения/Снимки экрана/lab/021.png){#fig:023 width=70%}
...
![Задание 22](home/glebbesputin/Изображения/Снимки экрана/lab/022.png){#fig:024 width=70%}

-q
--quiet
    Turn off Wget's output. 

![Задание 23](home/glebbesputin/Изображения/Снимки экрана/lab/023.png){#fig:025 width=70%}
...
![Задание 24](home/glebbesputin/Изображения/Снимки экрана/lab/024.png){#fig:026 width=70%}

![Задание 25](home/glebbesputin/Изображения/Снимки экрана/lab/025.png){#fig:027 width=70%}

gzip (сокращение от GNU Zip) — утилита сжатия и восстановления (декомпрессии) файлов, использующая алгоритм Deflate.

![Задание 26](home/glebbesputin/Изображения/Снимки экрана/lab/026.png){#fig:028 width=70%}
...
![Задание 27](home/glebbesputin/Изображения/Снимки экрана/lab/027.png){#fig:029 width=70%}
...
![Задание 28](home/glebbesputin/Изображения/Снимки экрана/lab/028.png){#fig:030 width=70%}

Регистр - маленькая буква, слово - `world`, а не `word`

![Задание 29](home/glebbesputin/Изображения/Снимки экрана/lab/029.png){#fig:031 width=70%}

![Задание 29](home/glebbesputin/Изображения/Снимки экрана/lab/029.png){#fig:032 width=70%}
